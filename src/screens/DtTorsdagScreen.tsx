...
function getWeekXpState(now: Date): { progress: number; remainingSeconds: number } {
  ...
  cycleStart.setHours(3, 0, 0, 0) // Start for nedtellinga hver fredag kl 03:00.
...
export default function DtTorsdagScreen() {
    ...
    <>
      ...
      <div className="xp-bar-shell">
        <div
          ...
          style={{
            width: progressWidth,
            backgroundImage: 'repeating-linear-gradient(to right, #54a916 0 28px, #7bd12d 28px 56px)',
